 ...
 */
import { health as api_app_health_health } from "~backend/app/health";
...
export namespace app {
    ...
    export class ServiceClient {
         ...
         */
        public async health(): Promise<ResponseType<typeof api_app_health_health>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/health`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_app_health_health>
        }
    }
}
