...
```bash
git remote add encore encore://academic-management-app-ui3i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/academic-management-app-ui3i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/academic-management-app-ui3i/settings/integrations/github)
